...
RETENTION = 50; % trigger for retention
...
if TRAINING == 1
    ...
    experiment.nTrials = 54; % 6 blocks x 54 trials = 324 trials               
end
...
if mod(subject.ID,2) == 0       % Use subject ID for assignment to ensure counterbalancing
    ...
    responseInstructionText = ['If you think the digit was included in the previous sequence, press L. \n\n' ...
        'If you think the digit was not included in the previous sequence, press A. \n\n'...
        'Use your left hand to press A and right hand to press L \n\n' ...
        'Press any key to continue.'];
elseif mod(subject.ID,2) == 1
    YesIsL = false;      % L is NO, A is YES
    responseInstructionText = ['If you think the digit was included in the previous sequence, press A. \n\n' ...
...
data.trialSOA{1, experiment.nTrials} = 0;
...
for thisTrial = 1:experiment.nTrials
    ...
    data.trialSOA{thisTrial} = mod(randperm(experiment.nTrials),round((timing.maxSOA-timing.minSOA)/flipInterval));    % Determine each trial's stimulus onset asychrony
