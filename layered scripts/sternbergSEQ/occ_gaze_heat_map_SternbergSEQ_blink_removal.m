...
%% Calculate significant differences l1 and l7
cfg                    = [];
...
saveas(gcf, '/Volumes/methlab/Students/Arne/MA/figures/gaze/SternbergSEQ_gaze_wm2.png');
...
saveas(gcf, '/Volumes/methlab/Students/Arne/MA/figures/gaze/SternbergSEQ_gaze_wm8.png');
