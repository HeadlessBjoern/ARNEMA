...
% - Sternberg actual task (6 blocks x 54 trials)
% - N-back training (4 trials)
% - N-back task (2 blocks x 100 trials)
...
% Run 6 blocks of 54 trials each (=324 trials; 6 x 18 min)
TASK = 'OCC_Sternberg';
for BLOCK = 1 : 6
